        ...
        <div className="container">
            ...
            <form onSubmit={submit}>
                <div className="mb-3">
                    ...
                    />
                    <p className="text-danger mt-2">{errors.email && setTouchedEmail && errors.email}</p>
                </div>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" 
                           ...
                           />
                    <p className="text-danger mt-2">{errors.password && setTouchedPassword && errors.password}</p>
                </div>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" 
                           ...
                           />
                    <p className="text-danger mt-2">{errors.name && setTouchedName && errors.name}</p>
                </div>
                <div>
